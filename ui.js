...
let buttonNext, buttonPrevious, buttonSelect, buttonAddPlayer1, buttonAddPlayer2, buttonPlay, buttonBack;
...
function initializeButtons() {
  ...
  Inputs.push({object: buttonSelect, valid_game_state: 'char_select', name: 'Select'});
...
function RenderMainMenu() {
  ...
  textSize(16);
  let buttonNext =findInputByName('Next');
  let buttonPrevious =findInputByName('Previous');
  let buttonPlay =findInputByName('Play');    
...
function RenderCharacterSelector() {
  ...
  // Hide navigation buttons (should be done automaticlly through the inputs ? !)
...
export { currentMenu, menus, displayCharacterSelectionPanel, RenderCharacterSelector, RenderMainMenu, positionButtons, UpdateUI, selectedCharacters, onWindowResize, findInputByName, initializeButtons };
